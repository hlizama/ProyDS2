...
public partial class Mantenimientos_ClienteMan01 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                grvClientes.DataSource = objClienteBL.ListarCliente();
    ...
    protected void grvClientes_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                Session["IDCliente"] = grvClientes.Rows[indicefila].Cells[1].Text;
                Response.Redirect("ClienteMan03.aspx");
            }
        }
        catch (Exception ex)
        {
