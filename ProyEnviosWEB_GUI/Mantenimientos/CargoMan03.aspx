<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CargoMan03.aspx.cs" Inherits="Mantenimientos_CargoMan03" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ACTUALIZACION DE CARGO&nbsp;</p>
    <table class="auto-style1">
        <tr>
            <td class="auto-style3">Tipo Cargo:</td>
            <td>
                <asp:DropDownList ID="cboTipoCargo" runat="server" Height="25px" Width="281px" AutoPostBack="True">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style1">Codigo Cargo:</td>
